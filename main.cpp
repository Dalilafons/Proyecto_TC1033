 ...
 * Objetos. Es un programa que captura diferentes tipos de 
 * productos (Alimentos y Artículos),los gestiona en un inventario y 
 * permite realizar ventas calculando los precios con polimorfismo.
 */
...
int main(void)
{
    ...
    // Mostrar precio:
    std::cout << "Precio del " << producto1->getNombre() << " : " 
    << producto1->calcularPrecio() << std::endl;
    std::cout << "Precio de la " << producto2->getNombre() << " : " 
    << producto2->calcularPrecio() << std::endl;
    ...
    if (Producto* productoEncontrado = inventario.buscarProducto(1)) {
        ...
        << ", Precio calculado: " << productoEncontrado->calcularPrecio() 
        << std::endl;
    }
    ...
    std::cout << "Total de la venta con 10% de descuento: " 
    << venta.calcularTotal(10.0) << std::endl;
